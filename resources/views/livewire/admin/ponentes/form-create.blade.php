    ...
    <div class="card">
        <form wire:submit="submitForm">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="foto"
                                                    wire:model="foto" accept="image/*" required>
                                                <label class="custom-file-label" for="foto"
                                                    data-browse="Elegir">Seleccione
                                                    archivo</label>
                                            </div>
                                            @error('foto')
                                                <span class="error text-danger">{{ $message }}</span>
            ...
            <div class="card-footer">
                <button class="btn btn-primary float-right" wire:loading.class="disabled"
            ...
            <div class="modal-content">
                <form wire:submit='registrar_grupo'>
                    <div class="modal-header">
                        <span class="modal-title fs-5" id="modalGrupoLabel">Agregar grupo de investigación</span>
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input wire:model='grupo_investigacion_add' type="text" name="grupo_investigacion_add"
                                class="form-control" id="grupo_investigacion_add">
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form wire:submit='registrar_institucion'>
                    <div class="modal-header">
                        <span class="modal-title fs-5" id="modalInstitucionLabel">Agregar Institución</span>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
